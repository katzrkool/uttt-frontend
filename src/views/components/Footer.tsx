...
function Footer(): JSX.Element {
    return (
        <footer>
            <p>This project is open sourced on Github: <a href="https://github.com/lkellar/uttt-frontend">Frontend</a> | <a href="https://github.com/lkellar/uttt-backend">Backend</a></p>
